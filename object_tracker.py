...
def main(_argv):
    ...
    while True:
        ...
        for track in tracker.tracks:
            ...
            if (center[0] < original_w/3) or (center[0] > 2*original_w/3) or (bbox[3] < 2*original_h/3):# Chia thành 4 vùng trái, giữa, phải, vùng trên trời nếu là trái hoặc phải hoặc trên trời thì an toàn-> xét phần ở giữa
                area_emergency = 0
                # x = 1
